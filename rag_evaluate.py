...
# ── Config ────────────────────────────────────────────────────────────────────
CHUNKS_FILE  = "/home/exouser/jyotsna/terra_mars/mars_training_data.jsonl"
...
with open(CHUNKS_FILE, "r", encoding="utf-8") as f:
    for line in f:
        ...
        if line:
            ...
            text = data.get("source_text", "") or data.get("input", "")
...
print(f"{'TerraMARS + RAG':<25} {str(round(kw_avg,1))+'%':>8} {str(round(num_avg,1))+'%':>8} {str(round(json_avg,1))+'%':>8} {str(round(overall,1))+'%':>8}")
